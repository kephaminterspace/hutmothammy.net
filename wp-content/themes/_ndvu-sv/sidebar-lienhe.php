...
?>
        <!-- <div class="top-m">
            ...
            <?php //echo do_shortcode('[contact-form-7 id="41" title="Gửi câu hỏi"]');?>
    	...
    	<div class="conner8 border box-bg top-m">
            ...
            <div class="box_ct2">
				<a href="<?php echo $ndvu['home7'];?>"><img class="per" src="<?php echo $ndvu['home6'];?>"></a>
            </div>
        </div>
    	<div class="conner8 border box-bg top-m">
        	<p class="box_tt">Video clips</p>
            <div class="box_ct2">
				<iframe width='100%' height='190' frameborder='0' class='ifkhachhang' src='http://www.youtube.com/embed/<?php echo $ndvu['home8'];?>' allowfullscreen="true"></iframe>
            </div>
        </div>
