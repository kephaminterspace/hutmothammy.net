 ...
 * @return int -1, 0, or 1 if $a is considered to be respectively less than, equa, or greater than $b.
 */
...
function wp_setup_nav_menu_item( $menu_item ) {
	if ( isset( $menu_item->post_type ) ) {
		if ( 'nav_menu_item' == $menu_item->post_type ) {
			...
			$menu_item->classes = empty( $menu_item->classes ) ? (array) get_post_meta( $menu_item->ID, '_, '_menu_item_classes', true ) : $menu_item->classes;
